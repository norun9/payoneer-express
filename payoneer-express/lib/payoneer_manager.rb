module PayoneerManager
  ...
  def self.set_config(currency)
    Payoneer.configure do |c|
      ...
      c.partner_username = Rails.application.secrets.payoneer[currency]['partner_username']
      c.partner_api_password = Rails.application.secrets.payoneer[currency]['partner_api_password']
